...
install_xcframework "${PODS_ROOT}/TXLiteAVSDK_TRTC/TXLiteAVSDK_TRTC/TXFFmpeg.xcframework" "TXLiteAVSDK_TRTC/TRTC" "framework" "ios-arm64_x86_64-simulator" "ios-arm64_armv7"
