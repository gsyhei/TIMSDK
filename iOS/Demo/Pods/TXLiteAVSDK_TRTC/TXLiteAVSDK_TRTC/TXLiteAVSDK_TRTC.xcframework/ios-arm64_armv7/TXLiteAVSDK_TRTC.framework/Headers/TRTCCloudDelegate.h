 ...
 * @param errCode Error code. `0`: recording succeeded; `-1`: recording failed; `-2`: recording was ended due to change of resolution or switch between the landscape and portrait mode；`-3`:The audio data or video data has not arrived so the formal
